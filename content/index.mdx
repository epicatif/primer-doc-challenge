...
description: 'Learn about Primer's integrated checkout UI solution'
---
...
- **Drop-in UI**: A ready-to-go checkout UI to start receiving payments using just a few lines of code.
- **Headless**: An in-depth [customizable](https://primer.io/docs/accept-payments/customize-universal-checkout/web) checkout experience with robust tailoring features.
