...
Headless Checkout allows you to use custom UIs for the payment methods you enable to your users, while Primer manages the entire checkout flow.

The Headless Checkout flow looks as follows:
...
The JSON response that confirms your new payment looks as follows:
